...
rand_od = generate_random_bush(g.tot_nodes(), 3, seed=2)  # initiating bush with 3 random branches
...
SUN(g, od_matrix=rand_od)
show_assignment(g, title=f'GENT assignment, theta = {2}')
assignment_parameters['logit_theta']=1
SUN(g, od_matrix=rand_od)
show_assignment(g, title=f'GENT assignment, theta = {1}')
assignment_parameters['logit_theta']=0.5
SUN(g, od_matrix=rand_od)
show_assignment(g, title=f'GENT assignment, theta = {0.5}')
assignment_parameters['logit_theta']=0.1
SUN(g, od_matrix=rand_od)
show_assignment(g, title=f'GENT assignment, theta = {0.1}')
assignment_parameters['logit_theta']=0.01
SUN(g, od_matrix=rand_od)
show_assignment(g, title=f'GENT assignment, theta = {0.01}')