...
#
#
from dyntapy.dta.core.network_loading.link_models.i_ltm_cls import ILTMNetwork, ILTMState
    ...
    for _id, link in enumerate(local_in_links):
        if sending_flow_init[link]:
            ...
            if t+vind[link]<0:
                ...
                # for all links with free flow travel times larger than dt we interpolate
